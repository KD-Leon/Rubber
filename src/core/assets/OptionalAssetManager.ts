...
export function buildRerankerSpec(pluginVersion: string, expectedSha256: string): AssetSpec {
    return {
        ...
        sizeMb: 12,
        expectedSha256,
        downloadUrl: `https://github.com/KD-Leon/Rubber/releases/download/${pluginVersion}-assets/ort-wasm-simd-threaded.wasm`,
    };
}
...
export function buildSelfDevSourceSpec(pluginVersion: string, expectedSha256: string): AssetSpec {
    return {
        ...
        sizeMb: 5,
        expectedSha256,
        downloadUrl: `https://github.com/KD-Leon/Rubber/releases/download/${pluginVersion}-assets/plugin-source.json`,
    };
}
...
export function buildOfficeBundleSpec(pluginVersion: string, expectedSha256: string): AssetSpec {
    return {
        ...
        sizeMb: 2,
        expectedSha256,
        downloadUrl: `https://github.com/KD-Leon/Rubber/releases/download/${pluginVersion}-assets/office-bundle.js`,
    };
}
...
export function buildPdfjsBundleSpec(pluginVersion: string, expectedSha256: string): AssetSpec {
    return {
        ...
        sizeMb: 2,
        expectedSha256,
        downloadUrl: `https://github.com/KD-Leon/Rubber/releases/download/${pluginVersion}-assets/pdfjs-bundle.js`,
    };
}
...
export function buildRerankerJsBundleSpec(pluginVersion: string, expectedSha256: string): AssetSpec {
    return {
        ...
        sizeMb: 0.6,
        expectedSha256,
        downloadUrl: `https://github.com/KD-Leon/Rubber/releases/download/${pluginVersion}-assets/reranker-bundle.js`,
    };
}
...
export function buildLocaleSpec(
    ...
    return {
        ...
        sizeMb: 1,
        expectedSha256,
        downloadUrl: `https://github.com/KD-Leon/Rubber/releases/download/${pluginVersion}-assets/${filename}`,
    };
}
